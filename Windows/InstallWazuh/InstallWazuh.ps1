...
Start-Process /wait msiexec.exe /qn /norestart /i ${env:tmp}\wazuh-agent-4.3.10.msi WAZUH_MANAGER=$WazuhManagerDNS WAZUH_REGISTRATION_SERVER=$WazuhManagerDNS WAZUH_AGENT_GROUP='default'
